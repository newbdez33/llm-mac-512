#!/usr/bin/env python3
"""
Download Qwen3-Coder-Next GGUF Q4_K_M with progress display
"""
...
print("="*60)
print("Qwen3-Coder-Next GGUF Q4_K_M 下载 (带进度条)")
print("="*60)

url = "https://huggingface.co/unsloth/Qwen3-Coder-Next-GGUF/resolve/main/Qwen3-Coder-Next-Q4_K_M.gguf"
output_file = os.path.expanduser("~/.cache/lm-studio/models/unsloth/Qwen3-Coder-Next-GGUF/Qwen3-Coder-Next-Q4_K_M.gguf")
